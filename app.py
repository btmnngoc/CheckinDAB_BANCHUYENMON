        ...
        if submitted:
            if name.strip() and email.strip() and committee.strip():
                try:
                    ...
                    # Tấm vé (Code 1 dòng để tránh lỗi Markdown của Streamlit)
                    ticket_html = f"""<div style="margin: 30px auto 10px auto; max-width: 400px; background: white; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.15); border: 2px solid #ffffff; position: relative; overflow: hidden; transform: perspective(1000px) translateZ(0);"><div style="background: linear-gradient(135deg, #004E98, #002B5E); color: white; padding: 25px 20px; text-align: center; position: relative;"><div style="position: absolute; top: 10px; right: 15px; opacity: 0.15; font-size: 40px;">⭐</div><h2 style="margin: 0; font-size: 22px; font-weight: 900; letter-spacing: 3px; text-transform: uppercase;">VÉ CHỜ PHỎNG VẤN</h2><p style="margin: 8px 0 0 0; font-size: 14px; opacity: 0.9; font-weight: 500; letter-spacing: 1px;">DAB CLUB</p></div><div style="position: relative; height: 0; border-top: 4px dashed #e2e8f0; margin-top: 0px; background: white;"><div style="position: absolute; top: -15px; left: -15px; width: 30px; height: 30px; background-color: #F8FAFC; border-radius: 50%; box-shadow: inset -4px 0 6px rgba(0,0,0,0.08);"></div><div style="position: absolute; top: -15px; right: -15px; width: 30px; height: 30px; background-color: #F8FAFC; border-radius: 50%; box-shadow: inset 4px 0 6px rgba(0,0,0,0.08);"></div></div><div style="background: linear-gradient(180deg, #FAFAFA 0%, #FFFFFF 100%); padding: 30px 20px; text-align: center; border-bottom: 2px dashed #f1f5f9;"><p style="margin: 0; font-size: 14px; color: #64748b; font-weight: 700; text-transform: uppercase; letter-spacing: 2px;">Số Thứ Tự</p><h1 style="margin: 15px 0; font-size: 100px; color: #FF6E2B; line-height: 1; font-weight: 900; text-shadow: 4px 4px 0px #FFE26E, 8px 8px 0px rgba(252, 94, 21, 0.15);">{stt_hien_tai}</h1></div><div style="padding: 25px 20px; text-align: center; background-color: white;"><h3 style="margin: 0 0 10px 0; color: #004E98; font-size: 20px; font-weight: 800; text-transform: uppercase;">{name}</h3><div style="display: inline-block; background: #FFF3EB; padding: 6px 16px; border-radius: 20px; border: 1px solid #FFD8C4;"><p style="margin: 0; color: #64748b; font-size: 14px; font-weight: 600;">Tiểu ban: <span style="font-weight: 900; color: #FC5E15; font-size: 15px;">{committee}</span></p></div><div style="margin: 20px auto 15px auto; height: 35px; width: 80%; background: repeating-linear-gradient(to right, #004E98, #004E98 4px, transparent 4px, transparent 8px, #004E98 8px, #004E98 10px, transparent 10px, transparent 14px, #004E98 14px, #004E98 20px, transparent 20px, transparent 22px); opacity: 0.7; border-radius: 2px;"></div><p style="margin: 0; font-size: 13px; color: #94a3b8; font-style: italic; font-weight: 500;">📸 Vui lòng ghi nhớ số vé này nhé!</p></div></div>"""                    st.markdown(ticket_html, unsafe_allow_html=True)
