                ...
                try:
                    ...
                    <div style="margin: 30px auto 10px auto; max-width: 380px; background: white; border-radius: 16px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); border: 1px solid #e2e8f0; position: relative; overflow: hidden;">
                        ...
                        <div style="position: relative; height: 0; border-top: 3px dashed #FC5E15; margin-top: 0px;">
                            <div style="position: absolute; top: -15px; left: -15px; width: 30px; height: 30px; background-color: #ffffff; border-radius: 50%; box-shadow: inset -3px 0 5px rgba(0,0,0,0.05);"></div>
                            <div style="position: absolute; top: -15px; right: -15px; width: 30px; height: 30px; background-color: #ffffff; border-radius: 50%; box-shadow: inset 3px 0 5px rgba(0,0,0,0.05);"></div>
                        </div>
